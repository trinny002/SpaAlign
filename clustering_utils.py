...
def split_rule(class_feat, mus, feat_sub_0, feat_sub_1, mu_sub_0, mu_sub_1, num_sub_0, num_sub_1, prior):
    ...
    N_k_1_tensor = torch.as_tensor(N_k_1)
    N_k_2_tensor = torch.as_tensor(N_k_2)

    return log_Hastings_ratio_split(1.0, N_k_1_tensor, N_k_2_tensor, log_ll_k1, log_ll_k2, log_ll_k, split_prob=0.1)
